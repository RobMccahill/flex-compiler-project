...
{
       0,     0,     3,    12,    15,    18,    22,    23,    25,    27,
      29,    31,    34,    38,    39,    44,    49,    54,    59,    62,
      64,    68,    69,    73,    75,    77,    78
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      18,     0,    -1,     7,    16,    20,     8,    16,    22,     9,
      16,    -1,     6,     4,    -1,    19,    16,    -1,    20,    19,
      16,    -1,    -1,    23,    -1,    24,    -1,    25,    -1,    27,
      -1,    21,    16,    -1,    22,    21,    16,    -1,    -1,    12,
       5,    14,     4,    -1,    12,     4,    14,     4,    -1,    13,
       5,    14,     4,    -1,    13,     4,    14,     4,    -1,    10,
      26,    -1,     4,    -1,    26,    15,     4,    -1,    -1,    11,
      28,    29,    -1,     3,    -1,     4,    -1,    -1,    29,    15,
      30,    29,    -1
};
...
{
       0,    43,    43,    52,    56,    57,    57,    59,    60,    61,
      62,    64,    65,    65,    67,    70,    74,    77,    81,    83,
      87,    92,    92,    99,   102,   105,   105
};
#endif
...
static const char *const yytname[] =
{
  ...
  "VARIABLE_SIZE", "BEGINING", "BODY", "END", "INPUT", "PRINT", "MOVE",
  "ADD", "TO", "SEPARATOR", "TERMINATOR", "$accept", "program",
  "declaration", "declarations", "statement", "statements",
  "move_operation", "add_operation", "input_operation", "input_items",
  "print_operation", "$@1", "print_items", "$@2", 0
};
#endif
...
{
       0,     0,     0,     6,     1,     0,     0,     0,     3,     4,
       0,     0,    13,     5,     0,    21,     0,     0,     0,     0,
       7,     8,     9,    10,    19,    18,     0,     0,     0,     0,
       0,    11,     0,     0,     0,    23,    24,    22,     0,     0,
       0,     0,     2,    12,    20,    25,    15,    14,    17,    16,
       0,    26
};
...
{
      11,    -6,    19,    14,   -25,    17,     6,     3,   -25,   -25,
       7,     9,    -5,   -25,    20,   -25,     8,    10,    12,    -9,
     -25,   -25,   -25,   -25,   -25,    15,    13,    18,    21,    22,
      23,   -25,    24,    25,    27,   -25,   -25,    28,    29,    30,
      34,    35,   -25,   -25,   -25,   -25,   -25,   -25,   -25,   -25,
      13,    28
};
...
{
      32,    14,    15,    16,    17,    14,    15,    16,    17,     5,
       3,    10,    27,    28,    29,    30,    35,    36,     1,     4,
       5,     8,     9,    12,    24,    13,    51,     0,    31,     0,
      34,    44,    38,    46,    47,    39,    40,    41,    48,    49,
      42,    43,     0,    45,    11,    33
};

static const yytype_int8 yycheck[] =
{
       9,    10,    11,    12,    13,    10,    11,    12,    13,     6,
      16,     8,     4,     5,     4,     5,     3,     4,     7,     0,
       6,     4,    16,    16,     4,    16,    50,    -1,    16,    -1,
      15,     4,    14,     4,     4,    14,    14,    14,     4,     4,
      16,    16,    -1,    15,     7,    19
};
...
{
       0,     7,    18,    16,     0,     6,    19,    20,     4,    16,
       8,    19,    16,    16,    10,    11,    12,    13,    21,    22,
      23,    24,    25,    27,     4,    26,    28,     4,     5,     4,
       5,    16,     9,    21,    15,     3,     4,    29,    14,    14,
      14,    14,    16,    16,     4,    15,     4,     4,     4,     4,
      30,    29
};
...
#line 52 "parser.y"
    {
	addVariableToList((yyvsp[(1) - (2)].number), (yyvsp[(2) - (2)].string));
;}
    break;
...
#line 67 "parser.y"
    {
					moveNumberToVariable((yyvsp[(2) - (4)].number), (yyvsp[(4) - (4)].string));
				;}
    break;
...
#line 70 "parser.y"
    {
					reassignVariable((yyvsp[(2) - (4)].string), (yyvsp[(4) - (4)].string));
				;}
    break;
...
#line 74 "parser.y"
    {
					addNumberToVariable((yyvsp[(2) - (4)].number), (yyvsp[(4) - (4)].string));
				;}
    break;
...
#line 77 "parser.y"
    {
			   		addVariables((yyvsp[(2) - (4)].string), (yyvsp[(4) - (4)].string));
			   	;}
    break;
...
#line 83 "parser.y"
    {
				if(!identifierExists((yyvsp[(1) - (1)].string)))
...
#line 87 "parser.y"
    {
				if(!identifierExists((yyvsp[(3) - (3)].string)))
					yyerror("variable does not exist!");
			;}
    break;
...
#line 102 "parser.y"
    {
				printf("%d", getValueForIdentifier((yyvsp[(1) - (1)].string)));
			;}
    break;
